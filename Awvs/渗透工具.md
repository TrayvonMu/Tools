...
5. 导入 docker-desktop-data 到期望迁移的目录： 
   ...
   ```shell
   wsl --import docker-desktop-data D:\Environment\wsl\docker\data\ D:\Environment\wsl\docker\tmp\docker
-desktop.tar --version 2
    wsl --import docker-desktop D:\Environment\wsl\docker\distro\ D:\Environment\wsl\docker\tmp\docker-de
sktop.tar --version 2
   ```

    （迁移目录 `D:\Environment\wsl\docker\` 可根据个人需求修改）
